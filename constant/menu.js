...
import { BotMessageSquare, Gift, Heart, MessageCircleMore, MessagesSquare, Percent, Star } from "@/lib/icons";
...
export const menu = [
    ...
    },
    {
      id: 2,
      title: "استشارة",
      icon: <BotMessageSquare size={20} strokeWidth={1} className="text-foreground" />,
      href: "/",
    },
    {
      id: 3,
    ...
    },
    {
        id: 4,
        title: "غرف",
        icon: <MessagesSquare size={15} strokeWidth={1} className="text-foreground" />,
        href: "/",
      },
      {
        id: 5,
        title: "المفضلة",
        icon: <Heart size={15} strokeWidth={1} className="text-foreground" />,
        href: "/",
      },
  ];
  ...
  export const socialMenu = [
    {
      id: 1,
      title: "تيك توك",
      icon: <Tiktok  className="text-foreground size-4" />,
      href: "/",
    },
    {
      id: 2,
      title: "انستجرام",
      icon: <Instagram   className="text-foreground size-4" />,
      href: "/",
    },
    {
      id: 3,
  ...
  export const filterMenu = [
    {
      id: 1,
      title: "حسب النجوم",
      icon: <Star  className="text-foreground size-4" />,
 
    },
    {
      id: 2,
      title: "حسب التعليقات",
      icon: <MessageCircleMore   className="text-foreground size-4" />,
