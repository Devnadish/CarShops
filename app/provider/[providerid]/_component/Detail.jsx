...
export const Detail = ({detail,description}) => {
  return (
    ...
    <div className='flex h-[80vh] w-full items-center bg-secondary/50 p-4 gap-4 flex-col rounded-lg rounded-tr-none '>
      <ScrollArea className="h-[30%] p-2 border border-border rounded-md w-full" dir="rtl">
      <Text >{description}</Text>
      </ScrollArea>
      <ScrollArea className="h-[60%] p-2 border border-border rounded-md w-full" dir="rtl">
      <Text >{detail}</Text>
      </ScrollArea>
    </div>
    </div>
